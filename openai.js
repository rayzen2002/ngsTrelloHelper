    ...
    messages: [
      {
        role: 'system',
        content: `
This is a Trello card description that helps me fill in the fields for my car insurance polic. 
...
For each client:
CLIENTE: [NAME]
DRIVER: [DRIVER NUMBER] (if not provided, leave blank)
CNH: 
DOB: 
DATA DA 1ª CNH: 
DATA DA 1ª DRIVER: 
...
- Apenas mude algo do template, caso o nome extraido do documento seja igual ao nome ja contido no template.
...
- Se certifique de remover qualquer possivel formatação adicional que possa vir a se tornar quando este texto for adicionado a um card do Trello
`,
      },
    ],
    model: 'gpt-3.5-turbo',
